...
Given how the constants above are involved with $\alpha$, it is possible to reduce the number of constants people need to know drastically ~$M_F^{W}L_F^{X}T_F^{Y}Q_F^{Z}=$% (besides masses of subatomic particles).
