...
%q_e = Q_F
%$$
$${\( \sqrt{c ~\alpha^2 ~ \hbar^2 ~T\over G~M~L^2}\)}^W {\({G \over c^2 }M_F{\hbar ~T\over M~L^2}\)}^X {\({G \over c^3 }M_F{\hbar ~T\over M~L^2}\)}^Y {\(q_e\)}^Z$$
...
$${\psDefBoxNodes{n2}{\mu _{0}} \over 2} ={\psDefBoxNodes{n4}{h ~ \alpha} \over c ~ q_e^2}; \hspace{0.5em} {\psDefBoxNodes{n5}{h ~ \alpha} \over c~ q_e^2}{ c^2 \over 2\pi }=k_e;\hspace{0.5em} \epsilon _0 ={1 \over \mu _0 c^2}%\qquad {\psDefBoxNodes{n3}{\mu _{0} }\over 2}{c ~ q_e^2 \over h} = \alpha
...
$${1.3899982\times 10^{24}  \approx {c ~ T_{SI}\over L_F} =D_C \over1.39\times 10^{24}}=0.999998675$$
 Calibrating scales to $D_C M_F$ and ammeter to $D_C q_e$ will result in the following:
\begin{multicols}{2}[\setlength{\columnseprule}{0pt}]\noindent\begin{align*}
T_F &\approx ~{1 \text{Second}\over \text{1.39}\times 10^{24}}\\
M_F &\approx {2.267061 \text{grams} \over \text{1.39}\times 10^{24}}
\end{align*}\noindent\begin{align*}
L_F &\approx ~{299792458 \text{Meters}\over \text{1.39}\times 10^{24}}\\
Q_F &\approx{222702.26\text{Coulumbs}\over \text{1.39}\times 10^{24}}
\end{align*}\noindent\end{multicols}\noindent
%$${\({{c ~ T_{SI}\over L_F}M_F \over \text{1.39}\times 10^{24}}\)}^W~ {\({299792458 \text{Meters}\over \text{1.39}\times 10^{24}}\)}^X~ {\({1 \text{Second}\over \text{1.39}\times 10^{24}}\)}^Y {\({{c ~ T_{SI}\over L_F}~q_e\over \text{1.39}\times 10^{24}}\)}^Z$$
...
\pagebreak
$${2.267061 \text{grams} \over \text{1.39}\times 10^{24}} \approx \sqrt{k_e^2~q_e^4~T \over c~G~M~L^2}= \sqrt{c~ \hbar^2 ~\alpha^2 ~T\over G~M~L^2}=M_F$$ 
\begin{align*}
%\text{Pfund Mass}~{c ~ T_{SI}\over L_F} &=\vcenter{\hbox{\includegraphics[width=1.6em]{P.ps}}}=~M_F~D_C &\approx 2.267061 \text{grams}
...
{\hbar \over c M_F} = {1.39 \times 10^{24} L_F \over 299792458}  &\approx 1 \text{Meter}
\end{align*}
\begin{align*}
%\text{Pfund Mass}~{c ~ T_{SI}\over L_F} &=\vcenter{\hbox{\includegraphics[width=1.6em]{P.ps}}}=~M_F~D_C &\approx 2.267061 \text{grams}
%\sqrt{k_e^2~q_e^4~T \over c~G~M~L^2}= \sqrt{c~ \hbar^2 ~\alpha^2 ~T\over G~M~L^2}=M_F&\approx {2.267061 \text{grams} \over \text{1.39e+24}}\\
